...
2. 《规范考试》是题型为不定项选择的闭卷笔试，回答正确率在90%及以上视为通过考试。考试通过后，其有效期至该学生毕业为止。未通过考试的学生需等待一周后才能再考。学生需携带学生证在208实验室大厅参考。考试时间为每学期开学前三周的周一到周五（09点-20点）。考试前请在实验室预约网页上先进行预约，然后准时到208考试。
